...
namespace TelaLoginCrud.Controllers
{
    ...
    public class VendaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdVenda,Produto,qnt,Preco,DataVenda")] Venda venda)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdVenda,Produto,qnt,Preco,DataVenda")] Venda venda)
        {
            if (id != venda.IdVenda)
            {
                return NotFound();
